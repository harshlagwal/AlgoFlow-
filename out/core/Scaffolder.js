...
const fs = require("fs");
class Scaffolder {
    static async buildProject(projectType, mode) {
    ...
    static scaffoldPython(dir, mode) {
        if (mode === 'advanced') {
    ...
    static getMainFile(dir, type, mode) {
